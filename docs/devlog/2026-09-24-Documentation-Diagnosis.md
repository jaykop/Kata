...
> 2026-09-25 후속: 아래 진단표·선별표는 당시 기록이다. 현재 작성 결과는
> [문서 현행화 기록](2026-09-25-Documentation-Maintenance.md)을 따른다.
> 런타임·에디터·조건 설명을 갱신했고 [이전 안내](../manual/Asset-Migration.md),
> [태스크 제작](../manual/Task-Authoring.md)과 결정 기록 4종을 작성했다.
> 현재 문서 목록은 [README](../README.md), 진행 상태는 [#11](https://github.com/jaykop/Kata/issues/11)·[#12](https://github.com/jaykop/Kata/issues/12)에서 관리한다.
...
이 진단은 시점 기록으로 유지한다. 위의 미반영 표기는 2026-09-24 기준이며 현재 문서 결과는 머리말의 후속 기록으로 연결한다.
당시 Next-Work-Plan·요청 메모는 삭제됐고 현재 진행 상태는 GitHub 이슈에서 관리한다.
