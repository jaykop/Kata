...
[수정 계획](../plan/Montage-Scrub-Plan.md)에 구현 순서와 미확정 경계 정책을 정리했다.
...
| [수정 계획](../plan/Montage-Scrub-Plan.md) | 엔진 프리뷰 재사용 제안과 완료 조건 |
| [다음 작업 계획](../plan/Next-Work-Plan.md) | 이번 진단과 미착수 수정 계획 연결 |
