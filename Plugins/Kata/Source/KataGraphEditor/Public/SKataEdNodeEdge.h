...
class KATAGRAPHEDITOR_API SKataEdNodeEdge : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SKataEdNodeEdge){}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UKataEdNodeEdge* InNode);
